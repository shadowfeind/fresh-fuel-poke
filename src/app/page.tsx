...
const menuCategories = [
  {
    ...
    items: [
      { name: "Bliss", price: "$98" },
      { name: "Neuro Fuel", price: "$98" },
      { name: "Low Calories", price: "$98" },
      { name: "Immunity Booster", price: "$98" },
      { name: "Gut Guardian", price: "$98" },
      { name: "Cardio Crunch", price: "$108" },
      { name: "Muscle Recovery", price: "$98" },
      { name: "Fuel Up Energy", price: "$108" },
    ],
  },
  {
    ...
    items: [
      { name: "Salmon Fillet", price: "$68" },
      { name: "Chicken Breast", price: "$58" },
      { name: "Tofu", price: "$38" },
      { name: "Kimchi", price: "$38" },
      { name: "Avocado", price: "$28" },
      { name: "Apple & Pineapple Mix", price: "$18" },
    ],
  },
  {
    title: "Drinks",
    ...
    items: [
      { name: "FFP Classic", price: "$38" },
      { name: "Flora-Fuel", price: "$38" },
      { name: "Re-Fuel", price: "$38" },
      { name: "Matchaka Coconut", price: "$38" },
      { name: "Cold Brew Coffee", price: "$38" },
      { name: "Homemade Lemonade", price: "$28" },
      { name: "Panna Still Water", price: "$28" },
      { name: "Pellegrino Sparkling Water", price: "$28" },
      { name: "Coconut Water", price: "$28" },
      { name: "12-8 Plum Soda", price: "$45" },
      { name: "Kuppa Kombucha (Strawberry + Szechuan Pepper)", price: "$45" },
      { name: "Kuppa Kombucha (Mango Passionfruit)", price: "$45" },
    ],
  },
  {
    title: "Sauce Options",
    ...
    items: [
      { name: "Honey Lime", price: "$12" },
      { name: "Ginger Miso", price: "$12" },
      { name: "Ponzu Tajin", price: "$12" },
      { name: "Turmeric Coco", price: "$12" },
    ],
  },
] as const;
